// FICHIER : src-tauri/src/services/workflow_service.rs
...
pub async fn set_sensor_value(storage: &StorageEngine, value: f64) -> RaiseResult<String> {
...
async fn run_workflow_loop(
    ...
    store
        .instances
        .insert(instance_handle.to_string(), updated_instance.clone());
